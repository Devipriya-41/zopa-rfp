...
const CompanyIntroduction = ({ data, onChange, errors }) => {
    ...
    return (
        <div className="component-container">
            <h2 className="font-bold mb-2">1. Company Introduction</h2>
            <p className="section-description mb-1">
                This information will be used to introduce your company in the
                RFP document.
            </p>

            <div className="form-group">
                <label htmlFor="companyName">
                    Enter company name <span className="required">*</span>
                </label>
                <input
                    type="text"
                    id="companyName"
            ...
            <div className="form-group">
                ...
                {errors.companyAddress && (
                    <div className="error-message">{errors.companyAddress}</div>
                )}
            </div>
            ...
            {/* <div className="preview-output">
                ...
                <div className="preview-text">
                    {data.name && data.address && (
                        <p>
                            <strong>{data.name}</strong> incorporated under
                            Indian Companies Act, 1956, having its office at{" "}
                            <strong>{data.address}</strong>, herein after
                            referred to as "Company" which expression shall
                            unless repugnant to the context or meaning thereof
                            and include its administrators and successors in
                    ...
                    {data.businessType && (
                        <p>
                            ...
                            <strong>{data.businessType}</strong>
                        </p>
                    )}
                </div>
            </div> */}
